...
#ifndef _herc_acq_attribute_t_h
#define _herc_acq_attribute_t_h

#ifdef __cplusplus
extern "C" {
#endif

typedef struct _herc_acq_attribute_t herc_acq_attribute_t;
struct _herc_acq_attribute_t
{
    char*      label;
    char*      value;
};
...
/**
 * Create a deep copy of a herc_acq_attribute_t.
 * When no longer needed, destroy it with herc_acq_attribute_t_destroy()
 */
herc_acq_attribute_t* herc_acq_attribute_t_copy(const herc_acq_attribute_t* to_copy);

/**
 * Destroy an instance of herc_acq_attribute_t created by herc_acq_attribute_t_copy()
 */
void herc_acq_attribute_t_destroy(herc_acq_attribute_t* to_destroy);

/**
 * Identifies a single subscription.  This is an opaque data type.
 */
typedef struct _herc_acq_attribute_t_subscription_t herc_acq_attribute_t_subscription_t;

/**
 * Prototype for a callback function invoked when a message of type
 * herc_acq_attribute_t is received.
 */
typedef void(*herc_acq_attribute_t_handler_t)(const lcm_recv_buf_t *rbuf,
             const char *channel, const herc_acq_attribute_t *msg, void *userdata);

/**
 * Publish a message of type herc_acq_attribute_t using LCM.
 *
 ...
 */
int herc_acq_attribute_t_publish(lcm_t *lcm, const char *channel, const herc_acq_attribute_t *msg);

/**
 * Subscribe to messages of type herc_acq_attribute_t using LCM.
 *
 ...
 */
herc_acq_attribute_t_subscription_t* herc_acq_attribute_t_subscribe(lcm_t *lcm, const char *channel, herc_acq_attribute_t_handler_t handler, void *userdata);

/**
 * Removes and destroys a subscription created by herc_acq_attribute_t_subscribe()
 */
...
/**
 * Encode a message of type herc_acq_attribute_t into binary form.
 *
 * @param buf The output buffer.
 * @param offset Encoding starts at this byte offset into @p buf.
 * @param maxlen Maximum number of bytes to write.  This should generally
 *               be equal to herc_acq_attribute_t_encoded_size().
...
/**
 * Decode a message of type herc_acq_attribute_t from binary form.
 * When decoding messages containing strings or variable-length arrays, this
 * function may allocate memory.  When finished with the decoded message,
 * release allocated resources with herc_acq_attribute_t_decode_cleanup().
 *
 ...
 */
int herc_acq_attribute_t_decode(const void *buf, int offset, int maxlen, herc_acq_attribute_t *msg);

/**
 * Release resources allocated by herc_acq_attribute_t_decode()
 * @return 0
 */
int herc_acq_attribute_t_decode_cleanup(herc_acq_attribute_t *p);

/**
 * Check how many bytes are required to encode a message of type herc_acq_attribute_t
 */
