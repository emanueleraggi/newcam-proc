...
#include "../../../src/ERDatabaseSystem/src/finddialog.h"
...
const QMetaObject FindDialog::staticMetaObject = {
    { &FindReplaceDialog::staticMetaObject, qt_meta_stringdata_FindDialog.data,
...
void *FindDialog::qt_metacast(const char *_clname)
{
    ...
    return FindReplaceDialog::qt_metacast(_clname);
}

int FindDialog::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = FindReplaceDialog::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    return _id;
}
