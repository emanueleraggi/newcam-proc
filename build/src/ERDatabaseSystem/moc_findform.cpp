...
#include "../../../src/ERDatabaseSystem/src/findform.h"
...
const QMetaObject FindForm::staticMetaObject = {
    { &FindReplaceForm::staticMetaObject, qt_meta_stringdata_FindForm.data,
      qt_meta_data_FindForm,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
