...
#include "../../../src/ERDatabaseSystem/ui/edittabledialog.h"
...
struct qt_meta_stringdata_edittabledialog_t {
    QByteArrayData data[4];
    char stringdata0[52];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_edittabledialog_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_edittabledialog_t qt_meta_stringdata_edittabledialog = {
    {
QT_MOC_LITERAL(0, 0, 15), // "edittabledialog"
QT_MOC_LITERAL(1, 16, 17), // "on_accept_clicked"
QT_MOC_LITERAL(2, 34, 0), // ""
QT_MOC_LITERAL(3, 35, 16) // "on_close_clicked"

    },
    "edittabledialog\0on_accept_clicked\0\0"
    "on_close_clicked"
};
...
const QMetaObject edittabledialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_edittabledialog.data,
      qt_meta_data_edittabledialog,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *edittabledialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_edittabledialog.stringdata0))
