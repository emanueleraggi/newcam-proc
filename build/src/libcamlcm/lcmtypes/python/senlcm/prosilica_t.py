...
class prosilica_t(object):
    __slots__ = ["utime", "self", "n_attributes", "PvAttributes", "start", "stop"]
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0xa1780a9515c79c1d+ senlcm.prosilica_attribute_t._get_hash_recursive(newparents)) & 0xffffffffffffffff
